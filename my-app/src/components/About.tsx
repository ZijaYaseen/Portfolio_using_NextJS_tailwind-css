...
const AboutMe = () => {
  ...
  <div className="flex-1 mt-6 md:mt-0 md:ml-4">
    <p className="p-4 mb-4 hover:border-purple border-2 border-purple rounded-2xl ease-in-out duration-500 hover:shadow-[0_0_15px_5px_rgba(138,43,226,0.7)]">
      <span className="text-purple">» </span> I am an enthusiastic <span className="text-purple">Computer Science</span> undergraduate from <span className="text-purple">Virtual University</span> of Islamabad, passionate about harnessing the power of technology to create impactful solutions.
    </p>
